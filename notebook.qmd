...
## Week 4 (June 26 to July 2)

This week, I'm setting the website up again. Yay! Tody said that he [wants me to replace the README entirely](https://github.com/animint/animint2/issues/97#issuecomment-1615428430), so that's happening, too.
...
- Toby created an organization, _animint_, for the `animint2` repository. I did some things with it:
  ...
  + I changed the settings so that we can control things with our PATs. If you want, go to `Settings > Third-party Access > Personal Access Tokens` to change it back.
  + I generated a PAT for `animint2`.
- Thoroughly updated and cleaned up the `website_setup.Rmd` document. NOT FINISHED YET.
- Editing `README.md` to be clearer and more immediately useful. NOT FINISHED YET.


## Week 5 (July 3 to July 9)
