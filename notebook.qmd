...
- R Markdown does give some control over alt text and captions. You can use `{r fig-alt: "foobar"}`. [Link](https://stackoverflow.com/a/61487713). But this obviously doesn't work for images not generated by a code chunk.
...
This section tracks work I've done immediately after GSOC ended.