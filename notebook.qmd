...
- In progress---I'm thoroughly updating and cleaning up the `website_setup.Rmd` document.
- In progress---I'm editing `README.qmd` to be clearer and more immediately useful. Later, I'll convert it to `README.md` for 
