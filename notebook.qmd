...
This week, I finally finished the quick start guide. And the README, too. I also worked a little on `website_setup.Rmd` and `_pkgdown.yml`.
...
This week, I continued working on `pkgdown.yml`.
...
This week, I finished `_pkgdown.yml`.
...
This week, I put a mostly-finished website online! Woot woot!
...
This week, I worked on improving the website, mostly with CSS.
...
[Work product submission week](https://developers.google.com/open-source/gsoc/help/work-product)! 🐈
