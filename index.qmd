...
As mentioned, I also want useful defaults for `fn_lln`. Let's have `data_vector` load a pseudo-random sample of six-sided dice by default.
...
First, let's look what `fn_lln` produces by default:
...
We may also be interested in seeing.
