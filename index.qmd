...
And, of course, it's immediately obvious without jitter. Last interactive scatterplot of the easy test: [Thanks to Toby Dylan Hocking for the suggestion to use a heatmap here!]{.aside}

```{r ani-corr-discrete}
#| label: fig-personality-discrete
#| fig-cap: "The discrete nature of the Big Five data."

count_ex <- sumscores |> count(extraversion)
count_co <- sumscores |> count(conscientiousness)
