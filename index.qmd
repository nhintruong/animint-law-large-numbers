...
The law of large numbers, sometimes called the weak law of large numbers, was named by S. D. Poisson in an article published in 1835.[^toc] He wrote, emphasis his, that
...
While Poisson named it, the LLN has its origins in a posthumous publication by Jacob Bernoulli over a century earlier.^[M. Denker. [Tercentennial anniversary of Bernoulli’s law of large numbers](doi.org/10.1090/S0273-0979-2013-01411-3). _Bull. Am. Math. Soc_. 2013.] Anyway, the history isn't especially important, and the LLN's consequences are straightforward. In contemporary terms: given some population mean and some sample mean, the sample mean approaches the population mean as the sample size increases.

The [LLN `animation` demonstration](https://yihui.org/animation/example/lln-ani/) just mentions that as
